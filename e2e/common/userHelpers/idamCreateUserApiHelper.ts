...
export async function createUser(
  ...
  switch (user) {
    case "citizen":
      ...
      email = `TEST_DIVORCE_USER_citizen.${uniqueId}@test.local`;
    ...
    case "caseworker":
      ...
      email = `TEST_DIVORCE_USER_worker.${uniqueId}@test.local`;
      roleNames = [
        "caseworker",
        "caseworker-divorce",
        "caseworker-divorce-admin",
        "caseworker-divorce-admin-beta",
      ];
      forename = "Caseworker";
      surname = "Divorce";
      break;
